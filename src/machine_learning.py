...
def balance_data(data: str):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_res, y_res, random_state=42, test_size=0.07)
...
def plot_decesion_tree(data: str):
    ...
    X_train, X_test, y_train, y_test = train_test_split(x, y, random_state=42, test_size=0.07)
